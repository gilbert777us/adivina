	...
	<head>
    	...
    	<script>
    		function miSubmit(ine) {
    			if (ine=='si')
    			{
     				document.getElementById('posicion').value=4; 
     				// no se mete el final de la confusión (el que mete el no) 
     				// ni el 404
    				document.getElementById('theForm').action="UJ7L6K8J4HF32Y495HG5B5V3A<?php echo getFinal(1)?>.php"; 				
    			}
    			else
    			{
    				document.getElementById('posicion').value=3;
    				// no se mete el final de la confusión (el que mete el no).
	...
	<body onload="miOnload()"> 
		...
		<form method="post" id="theForm" action="UJ7L6K3J4HF32Y495HG5B5V3A.php"> 
			...
			<div id="capa1">
				...
				<h2><?php echo $_SESSION["preguntas"][3]?></h2>
